                    ...
                    <section class="achievements compact largeable-flex-wrap">
                        <div class="achievement a largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        ...
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="3.4875 155"/>
                                    </svg>
                            ...
                            <div class="info">
                                ...
                                <div class="text">Repositories have been deployed 545 times</div>
                            </div>
                        </div>
                        ...
                        <div class="achievement c largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        <circle class="gauge-base" r="25" cx="28" cy="28"/>
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="57.10526315789473 155"/>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" mask="url(#mask)">
                                        <g stroke-linecap="round" stroke-width="2" fill="none" fill-rule="evenodd">
                                            <g stroke="#2088FF">
                            ...
                            <div class="info">
                                <div class="title">
                                    ...
                                    Developer
                                    <span class="gh">ranked 5.47m out of 93m users</span>
                                    <div class="value-wrapper">
                                        <div class="value">8</div>
                                    </div>
                                </div>
                                <div class="text">Published 8 public repositories</div>
                            </div>
                        </div>
                        <div class="achievement c largeable-width-half">
                            <div class="icon">
                        ...
                        <div class="achievement c largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        <circle class="gauge-base" r="25" cx="28" cy="28"/>
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="24.14572864321608 155"/>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" mask="url(#mask)">
                            ...
                            <div class="info">
                                ...
                                <div class="text">Following 32 users</div>
                            </div>
                        </div>
                        <div class="achievement c largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        <circle class="gauge-base" r="25" cx="28" cy="28"/>
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="23.36683417085427 155"/>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" mask="url(#mask)">
                            ...
                            <div class="info">
                                ...
                                <div class="text">Starred 31 repositories</div>
                            </div>
                        </div>
                        <div class="achievement c largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        <circle class="gauge-base" r="25" cx="28" cy="28"/>
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="16.31578947368421 155"/>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" mask="url(#mask)">
                                        <g stroke-width="2" fill="none" fill-rule="evenodd">
                            ...
                            <div class="info">
                                ...
                                <div class="text">Published 3 gists</div>
                            </div>
                        </div>
                        <div class="achievement c largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        <circle class="gauge-base" r="25" cx="28" cy="28"/>
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="12.462311557788945 155"/>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" mask="url(#mask)">
                            ...
                            <div class="info">
                                <div class="title">
                                    <span class="prefix"></span>
                                    Influencer
                                    <span class="gh">ranked 545k out of 93m users</span>
                                    <div class="value-wrapper">
                                        <div class="value">17</div>
                                    </div>
                                </div>
                                <div class="text">Followed by 17 users</div>
                            </div>
                        </div>
                        <div class="achievement c largeable-width-half">
                            <div class="icon">
                            ...
                            <div class="info">
                                ...
                                <div class="text">Participated in discussions 4 times</div>
                            </div>
                        </div>
                        <div class="achievement c largeable-width-half">
                            <div class="icon">
                        ...
                        <div class="achievement c largeable-width-half">
                            ...
                            <div class="info">
                                <div class="title">
                                    <span class="prefix"></span>
                                    Inspirer
                                    <span class="gh">ranked 4.11m out of 321m repositories</span>
                                    <div class="value-wrapper">
                                        <div class="value">1</div>
                                    </div>
                                </div>
